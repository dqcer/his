...
public class Info {
	...
	{
		User user = (User)(request.getSession().getAttribute("admin")==null?request.getSession().getAttribute("user"):request.getSession().getAttribute("admin"));
		return user;
	}
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg()\" src=\"/js/nopic.jpg\" id=txt height=\""+height+"\"/>";
